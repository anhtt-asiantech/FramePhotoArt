...
public abstract class StickerView extends FrameLayout{
    ...
    private void init(Context context){
        ...
        LayoutParams iv_showhide_params =
                new LayoutParams(
                        convertDpToPixel(BUTTON_SIZE_DP, getContext()),
                        convertDpToPixel(BUTTON_SIZE_DP, getContext())
                );
        iv_showhide_params.gravity = Gravity.BOTTOM | Gravity.LEFT;
        ...
        this.addView(iv_showhide,iv_showhide_params);
        ...
        this.iv_showhide.setOnClickListener(new OnClickListener() {
            @Override
